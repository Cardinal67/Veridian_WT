 ...
 */
const isApiKeySet = import.meta.env.VITE_GEMINI_API_KEY && import.meta.env.VITE_GEMINI_API_KEY !== 'YOUR_GEMINI_API_KEY_HERE';
        ...
        <div className="space-y-6">
            ...
            {!isApiKeySet && (
                <div className="bg-yellow-500/10 border border-yellow-500 text-yellow-400 p-4 rounded-lg">
                    ...
                    <p className="text-sm">A Gemini API Key is required to use this feature. Please add your key to a <code>.env</code> file (VITE_GEMINI_API_KEY) to enable the AI Planner.</p>
                </div>
            )}
