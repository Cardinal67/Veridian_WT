...
/**
 * This file contains a collection of stateless functional components, each representing an SVG icon.
 * Using SVG icons as React components provides several benefits:
 * 1. They can be easily styled with CSS or Tailwind classes (e.g., changing color, size).
 * 2. They are part of the React component tree, making them easy to import and use.
 * 3. It keeps the JSX of other components cleaner by abstracting away the complex SVG path data.
 *
 * Each icon component accepts standard SVG props (`React.SVGProps<SVGSVGElement>`) which allows
 * for customization like `className`, `width`, `height`, etc., from the parent component.
 */

export const Dumbbell: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.4 14.4 9.6 9.6" /><path d="M18.657 21.485a2 2 0 1 1-2.829-2.828l-1.767 1.768a2 2 0 1 1-2.829-2.828l-1.768 1.768a2 2 0 1 1-2.828-2.828l1.767-1.768a2 2 0 1 1 2.829-2.828l1.768-1.768a2 2 0 1 1 2.828 2.828l1.768-1.768a2 2 0 1 1 2.828 2.828z" /><path d="m21.5 21.5-1.4-1.4" /><path d="M15.454 15.454 14 14" /><path d="M3.929 15.485a2 2 0 1 1-2.828-2.828l1.767-1.768a2 2 0 1 1-2.829-2.828l1.768-1.768a2 2 0 1 1 2.829 2.829l-1.768 1.768a2 2 0 1 1 2.828 2.828z" /><path d="m2.5 2.5 1.4 1.4" /><path d="M8.546 8.546 10 10" />
  </svg>
);
...
export const CloudOff: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m2 2 20 20"/><path d="M5.89 5.89C4.12 7.27 3 9.44 3 12a7 7 0 0 0 12.73 4.3"/><path d="M17.5 19H17a4.5 4.5 0 0 0 .5-8.83A4.5 4.5 0 0 0 13 6.5"/>
    </svg>
);
...
export const HeartPulse: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M3.22 12H9.5l.7-1.5L11.5 14l1.8-3 2.2 4.5H20.8"/>
    </svg>
);
