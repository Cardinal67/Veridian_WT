        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex">
                  <input type="number" id="weight" value={weight} onChange={e => setWeight(Math.max(0, parseFloat(e.target.value)))} disabled={isWeightInputDisabled} className="w-full bg-brand-dark border border-brand-border rounded-l-lg p-2 border disabled:bg-brand-dark/50" />
