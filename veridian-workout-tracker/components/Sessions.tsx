...
/**
 * Defines the props for the Sessions component.
 * It receives the list of all sessions and callbacks to interact with them.
 * Note: This component appears to be identical to WorkoutHistory.tsx.
 */
...
/**
 * The Sessions component displays a list of all past workout sessions.
 ...
 * Note: This component's functionality is a duplicate of the WorkoutHistory component.
 */
const Sessions: React.FC<SessionsProps> = ({ sessions, onDelete, onEdit, onInitiateSaveRoutine, activeSession }) => {
